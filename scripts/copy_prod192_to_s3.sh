# This script copies product 192 to an Amazon S3 bucket.  

this_progname="$(basename $BASH_SOURCE)"
this_product="prod192"
product_type="free"
...
previous_file="$previous_files_dir/prod192"
echo previous prod192 file is $previous_file

prod192_file_pattern="Prod192_????_*"
latest_file=`ls -tr $bulk_output_dir$prod192_file_pattern | tail -1`
...
then
    ...
    then
        ...
        renamed_file=$(basename ${latest_file%_*}).dat
