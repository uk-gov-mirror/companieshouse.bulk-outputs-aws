# This script copies product 207 to an Amazon S3 bucket.  

this_progname="$(basename $BASH_SOURCE)"
this_product="prod207"
product_type="free"
...
previous_file="$previous_files_dir/prod207"
echo previous prod207 file is $previous_file

prod207_file_pattern="Prod207_????_*"
latest_file=`ls -tr $bulk_output_dir$prod207_file_pattern | tail -1`
