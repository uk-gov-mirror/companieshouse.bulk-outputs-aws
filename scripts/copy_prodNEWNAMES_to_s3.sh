# This script copies product NEWNAMES to an Amazon S3 bucket.  

this_progname="$(basename $BASH_SOURCE)"
this_product="prodNEWNAMES"
product_type="free"
...
previous_file="$previous_files_dir/prodNEWNAMES"
echo previous prodNEWNAMES file is $previous_file

prodNEWNAMES_file_pattern="ProdNEWNAMES_????_*"
latest_file=`ls -tr $bulk_output_dir$prodNEWNAMES_file_pattern | tail -1`
