# This script copies product 212 to an Amazon S3 bucket.  

this_progname="$(basename $BASH_SOURCE)"
this_product="prod212"
product_type="free"
...
previous_file="$previous_files_dir/prod212"
echo previous prod212 file is $previous_file

prod212_file_pattern="Prod212_????_*"
latest_file=`ls -tr $bulk_output_dir$prod212_file_pattern | tail -1`
