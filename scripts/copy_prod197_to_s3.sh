# This script copies product 197 to an Amazon S3 bucket.  

this_progname="$(basename $BASH_SOURCE)"
this_product="prod197"
product_type="free"
...
previous_file="$previous_files_dir/prod197"
echo previous prod197 file is $previous_file

prod197_file_pattern="Prod197_????_*"
latest_file=`ls -tr $bulk_output_dir$prod197_file_pattern | tail -1`
