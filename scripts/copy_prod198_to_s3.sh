# This script copies product 198 to an Amazon S3 bucket.  

this_progname="$(basename $BASH_SOURCE)"
this_product="prod198"
product_type="free"
...
previous_file="$previous_files_dir/prod198"
echo previous prod198 file is $previous_file

prod198_file_pattern="Prod198_????_*"
latest_file=`ls -tr $bulk_output_dir$prod198_file_pattern | tail -1`
